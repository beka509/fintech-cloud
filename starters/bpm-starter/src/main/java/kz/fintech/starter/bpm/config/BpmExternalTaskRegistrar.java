...
import kz.fintech.starter.bpm.annotations.EnableBpmExternalTasks;
...
@Slf4j
public class BpmExternalTaskRegistrar implements ImportBeanDefinitionRegistrar, ResourceLoaderAware, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata metadata, BeanDefinitionRegistry registry) {
        ...
        AnnotationTypeFilter annotationTypeFilter = new AnnotationTypeFilter(BpmExternalTaskContainer.class);
    ...
    private void registerExternalTaskClient(BeanDefinitionRegistry registry) {
        BeanDefinitionBuilder definition = BeanDefinitionBuilder.genericBeanDefinition(BpmExternalTaskClientFactoryBean.class)
        ...
        log.info("Registered external task client bean " + beanName + " of class " + BpmExternalTaskClientFactoryBean.class);
    }
    ...
    private Set<String> getBasePackages(AnnotationMetadata metadata) {
        Map<String, Object> attributes = metadata.getAnnotationAttributes(EnableBpmExternalTasks.class.getCanonicalName());
