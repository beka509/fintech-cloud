...
public class CustomRequestExecutor extends RequestExecutor {

    public CustomRequestExecutor(RequestInterceptorHandler requestInterceptorHandler, ObjectMapper objectMapper) {
