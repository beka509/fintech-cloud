...
public class EurekaEngineClientNew extends EngineClient {

    protected final CustomRequestExecutorNew engineInteraction;
    protected final LoadBalancerClient loadBalancerClient;
    protected final URI baseUri;

    @SneakyThrows
    public EurekaEngineClientNew(String workerId, int maxTasks, Long asyncResponseTimeout, String baseUrl, CustomRequestExecutorNew engineInteraction, LoadBalancerClient loadBalancerClient) {
    ...
    @SneakyThrows
    public EurekaEngineClientNew(String workerId, int maxTasks, Long asyncResponseTimeout, String baseUrl, CustomRequestExecutorNew engineInteraction, boolean usePriority, LoadBalancerClient loadBalancerClient) {
    ...
    public String getBaseUrl() {
        ...
        if (serviceInstance == null) throw new CamundaServerNotFoundExceptionNew(baseUri.getHost() + " not found");
