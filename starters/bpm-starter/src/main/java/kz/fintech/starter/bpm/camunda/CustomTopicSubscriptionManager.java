...
import static kz.fintech.starter.bpm.utils.Helpers.maxThreads;

@Slf4j
public class CustomTopicSubscriptionManager extends TopicSubscriptionManager {

    private final ThreadPoolExecutor executor;

    CustomTopicSubscriptionManager(EngineClient engineClient,
    ...
    public void run() {
        while (isRunning.get()) {
            try {
                acquire();
            } catch (CamundaServerNotFoundException ignored) {
                suspend(10_000);
            } catch (Throwable e) {
